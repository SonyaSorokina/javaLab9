...
<main>
    <div class="container py-4">
        ...
        <p class="card-text">Оставте заявку и мы вам обязательно перезвоним</p>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Ваше предложение</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        <button id = "myButton" class="btn btn-primary btn-lg" type="button" onclick="location.href='/services'">Отправить</button>
